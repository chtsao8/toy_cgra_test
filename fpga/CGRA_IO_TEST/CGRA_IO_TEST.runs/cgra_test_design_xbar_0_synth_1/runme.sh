...
HD_PWD='C:/Users/chess/OneDrive/Documents/Stanford/EE272C/CGRA_IO_TEST/CGRA_IO_TEST.runs/cgra_test_design_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cgra_test_design_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cgra_test_design_xbar_0.tcl
