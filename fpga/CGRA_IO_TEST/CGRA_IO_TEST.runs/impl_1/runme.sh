...
HD_PWD='C:/Users/chess/OneDrive/Documents/Stanford/EE272C/CGRA_IO_TEST/CGRA_IO_TEST.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cgra_test_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cgra_test_design_wrapper.tcl -notrace
