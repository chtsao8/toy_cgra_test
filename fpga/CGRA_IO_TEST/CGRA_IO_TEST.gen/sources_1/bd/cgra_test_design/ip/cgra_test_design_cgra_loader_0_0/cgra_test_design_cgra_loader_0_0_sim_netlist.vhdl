...
--               c:/Users/chess/OneDrive/Documents/Stanford/EE272C/CGRA_IO_TEST/CGRA_IO_TEST.gen/sources_1/bd/cgra_test_design/ip/cgra_test_design_cgra_loader_0_0/cgra_test_design_cgra_loader_0_0_sim_netlist.vhdl
...
entity cgra_test_design_cgra_loader_0_0_dff is
  port (
  ...
  attribute ORIG_REF_NAME of cgra_test_design_cgra_loader_0_0_dff : entity is "dff";
end cgra_test_design_cgra_loader_0_0_dff;

architecture STRUCTURE of cgra_test_design_cgra_loader_0_0_dff is
begin
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity cgra_test_design_cgra_loader_0_0_dff_0 is
  port (
    \q_reg[0]_0\ : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of cgra_test_design_cgra_loader_0_0_dff_0 : entity is "dff";
end cgra_test_design_cgra_loader_0_0_dff_0;

architecture STRUCTURE of cgra_test_design_cgra_loader_0_0_dff_0 is
begin
\q_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => clk,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity cgra_test_design_cgra_loader_0_0_dff_1 is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of cgra_test_design_cgra_loader_0_0_dff_1 : entity is "dff";
end cgra_test_design_cgra_loader_0_0_dff_1;

architecture STRUCTURE of cgra_test_design_cgra_loader_0_0_dff_1 is
begin
\q_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => clk,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity cgra_test_design_cgra_loader_0_0_dffr is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of cgra_test_design_cgra_loader_0_0_dffr : entity is "dffr";
end cgra_test_design_cgra_loader_0_0_dffr;

architecture STRUCTURE of cgra_test_design_cgra_loader_0_0_dffr is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \cgra_test_design_cgra_loader_0_0_dffr__parameterized0\ is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of \cgra_test_design_cgra_loader_0_0_dffr__parameterized0\ : entity is "dffr";
end \cgra_test_design_cgra_loader_0_0_dffr__parameterized0\;

architecture STRUCTURE of \cgra_test_design_cgra_loader_0_0_dffr__parameterized0\ is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \cgra_test_design_cgra_loader_0_0_dffr__parameterized0_2\ is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of \cgra_test_design_cgra_loader_0_0_dffr__parameterized0_2\ : entity is "dffr";
end \cgra_test_design_cgra_loader_0_0_dffr__parameterized0_2\;

architecture STRUCTURE of \cgra_test_design_cgra_loader_0_0_dffr__parameterized0_2\ is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \cgra_test_design_cgra_loader_0_0_dffr__parameterized1\ is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of \cgra_test_design_cgra_loader_0_0_dffr__parameterized1\ : entity is "dffr";
end \cgra_test_design_cgra_loader_0_0_dffr__parameterized1\;

architecture STRUCTURE of \cgra_test_design_cgra_loader_0_0_dffr__parameterized1\ is
begin
\q_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => clk,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity cgra_test_design_cgra_loader_0_0_dffre is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of cgra_test_design_cgra_loader_0_0_dffre : entity is "dffre";
end cgra_test_design_cgra_loader_0_0_dffre;

architecture STRUCTURE of cgra_test_design_cgra_loader_0_0_dffre is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity cgra_test_design_cgra_loader_0_0_brute_force_synchronizer is
  port (
    button_sync : out STD_LOGIC;
    btn_s : in STD_LOGIC;
    clk : in STD_LOGIC
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of cgra_test_design_cgra_loader_0_0_brute_force_synchronizer : entity is "brute_force_synchronizer";
end cgra_test_design_cgra_loader_0_0_brute_force_synchronizer;

architecture STRUCTURE of cgra_test_design_cgra_loader_0_0_brute_force_synchronizer is
  signal ff1_n_0 : STD_LOGIC;
  signal ff2_n_0 : STD_LOGIC;
begin
ff1: entity work.cgra_test_design_cgra_loader_0_0_dff
     port map (
      btn_s => btn_s,
      clk => clk,
      \q_reg[0]_0\ => ff1_n_0
    );
ff2: entity work.cgra_test_design_cgra_loader_0_0_dff_0
     port map (
      clk => clk,
      \q_reg[0]_0\ => ff2_n_0,
      \q_reg[0]_1\ => ff1_n_0
    );
ff3: entity work.cgra_test_design_cgra_loader_0_0_dff_1
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity cgra_test_design_cgra_loader_0_0_debouncer is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of cgra_test_design_cgra_loader_0_0_debouncer : entity is "debouncer";
end cgra_test_design_cgra_loader_0_0_debouncer;

architecture STRUCTURE of cgra_test_design_cgra_loader_0_0_debouncer is
...
begin
  Q(0) <= \^q\(0);
counter: entity work.cgra_test_design_cgra_loader_0_0_dffr
     port map (
      D(0) => counter_n_0,
...
state: entity work.\cgra_test_design_cgra_loader_0_0_dffr__parameterized0_2\
     port map (
      D(0) => counter_n_0,
      Q(1) => current_state_q(1),
      Q(0) => \^q\(0),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity cgra_test_design_cgra_loader_0_0_one_pulse is
  port (
    last_value : out STD_LOGIC;
    btn_r : in STD_LOGIC;
    Q : in STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of cgra_test_design_cgra_loader_0_0_one_pulse : entity is "one_pulse";
end cgra_test_design_cgra_loader_0_0_one_pulse;

architecture STRUCTURE of cgra_test_design_cgra_loader_0_0_one_pulse is
begin
last_value_storage: entity work.\cgra_test_design_cgra_loader_0_0_dffr__parameterized1\
     port map (
      Q(0) => Q(0),
      btn_r => btn_r,
      clk => clk,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity cgra_test_design_cgra_loader_0_0_button_press_unit is
  port (
    last_value : out STD_LOGIC;
    Q : out STD_LOGIC_VECTOR ( 0 to 0 );
    btn_r : in STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of cgra_test_design_cgra_loader_0_0_button_press_unit : entity is "button_press_unit";
end cgra_test_design_cgra_loader_0_0_button_press_unit;

architecture STRUCTURE of cgra_test_design_cgra_loader_0_0_button_press_unit is
  signal \^q\ : STD_LOGIC_VECTOR ( 0 to 0 );
  signal button_sync : STD_LOGIC;
begin
  Q(0) <= \^q\(0);
debounce: entity work.cgra_test_design_cgra_loader_0_0_debouncer
     port map (
      Q(0) => \^q\(0),
      btn_r => btn_r,
      button_sync => button_sync,
...
one_pulse: entity work.cgra_test_design_cgra_loader_0_0_one_pulse
     port map (
      Q(0) => \^q\(0),
      btn_r => btn_r,
      clk => clk,
...
sync: entity work.cgra_test_design_cgra_loader_0_0_brute_force_synchronizer
     port map (
      btn_s => btn_s,
      button_sync => button_sync,
      clk => clk
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity cgra_test_design_cgra_loader_0_0_cgra_loader is
  port (
    gpio_out_16 : out STD_LOGIC_VECTOR ( 3 downto 0 );
    gpio_out_1 : out STD_LOGIC;
    btn_r : in STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of cgra_test_design_cgra_loader_0_0_cgra_loader : entity is "cgra_loader";
end cgra_test_design_cgra_loader_0_0_cgra_loader;

architecture STRUCTURE of cgra_test_design_cgra_loader_0_0_cgra_loader is
...
begin
counter: entity work.cgra_test_design_cgra_loader_0_0_dffre
     port map (
      btn_r => btn_r,
      clk => clk,
      count(3 downto 0) => count(3 downto 0),
...
start_btn: entity work.cgra_test_design_cgra_loader_0_0_button_press_unit
     port map (
...
state_reg: entity work.\cgra_test_design_cgra_loader_0_0_dffr__parameterized0\
     port map (
      Q(0) => button_debounced,
      btn_r => btn_r,
      clk => clk,
...
entity cgra_test_design_cgra_loader_0_0 is
  ...
  attribute NotValidForBitStream of cgra_test_design_cgra_loader_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of cgra_test_design_cgra_loader_0_0 : entity is "cgra_test_design_cgra_loader_0_0,cgra_loader,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of cgra_test_design_cgra_loader_0_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of cgra_test_design_cgra_loader_0_0 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of cgra_test_design_cgra_loader_0_0 : entity is "cgra_loader,Vivado 2021.2";
end cgra_test_design_cgra_loader_0_0;

architecture STRUCTURE of cgra_test_design_cgra_loader_0_0 is
...
begin
  \^btn_r\ <= btn_r;
  io_rst <= \^btn_r\;
inst: entity work.cgra_test_design_cgra_loader_0_0_cgra_loader
     port map (
      btn_r => \^btn_r\,
      btn_s => btn_s,
      clk => clk,
