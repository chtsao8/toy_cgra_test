...
set_property PACKAGE_PIN Y10  [get_ports { io_clk }];  # "JA3"
set_property PACKAGE_PIN AB9  [get_ports { io_rst }];  # "JA9"
set_property PACKAGE_PIN AA9  [get_ports { gpio_out_1 }];  # "JA4"
set_property PACKAGE_PIN AA8  [get_ports { gpio_in_1_tri_io }];  # "JA10"


# ----------------------------------------------------------------------------
# JB Pmod - Bank 13
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN W12 [get_ports { gpio_out_16[0] }];  # "JB1"
set_property PACKAGE_PIN W11 [get_ports { gpio_out_16[1] }];  # "JB2"
set_property PACKAGE_PIN V10 [get_ports { gpio_out_16[2] }];  # "JB3"
set_property PACKAGE_PIN W8 [get_ports { gpio_out_16[3] }];  # "JB4"
set_property PACKAGE_PIN V12 [get_ports { gpio_in_16_tri_io[0] }];  # "JB7"
set_property PACKAGE_PIN W10 [get_ports { gpio_in_16_tri_io[1] }];  # "JB8"
set_property PACKAGE_PIN V9 [get_ports { gpio_in_16_tri_io[2] }];  # "JB9"
set_property PACKAGE_PIN V8 [get_ports { gpio_in_16_tri_io[3] }];  # "JB10"
...
set_property PACKAGE_PIN R16 [get_ports { btn_r }];  # "BTND"
#set_property PACKAGE_PIN N15 [get_ports { btn_tri_io[2] }];  # "BTNL"
#set_property PACKAGE_PIN R18 [get_ports { btn_tri_io[3] }];  # "BTNR"
#set_property PACKAGE_PIN T18 [get_ports { btn_tri_io[4] }];  # "BTNU"
